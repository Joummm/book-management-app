...
export const translations = {
  pt: {
    ...
    personalReadingSpeed: "Velocidade de Leitura Pessoal",
    ...
    dashboardSubtitle: "Acompanha o teu progresso literário e descobre novos hábitos.",
    pagesRead: "Páginas Lidas",
    totalRead: "Páginas totais",
    readInYear: "Lidos em {year}",
    ...
    wouldReadAgain: "Pretendes reler?",
    wouldRecommend: "Recomendarias?",
    yes: "Sim",
    no: "Não",
    maybe: "Talvez",
    ...
    wasRemovedFromCollection: "foi removido da sua coleção.",
    deleteConfirm:
    ...
    hasReview: "Tem avaliação",
    personajesCount: "Personagens",
    quotesCount: "Citações",
    addedOn: "Adicionado em",
    viewDetails: "Ver Detalhes",
    addedToFavorites: "Adicionado aos Favoritos",
    addedToFavoritesDesc: "foi adicionado aos seus favoritos",
    ...
    manageCollectionsForBook: "Gerenciar coleções para este livro",
    collectionsUpdated: "Coleções atualizadas!",
    collectionDeleted: "Coleção eliminada com sucesso!",
    booksInCollectionCount: "{count} livros",
    noBooksInCollection: "Nenhum livro nesta coleção",
    items: "itens",
    ...
    authorBio: "Biografía do Autor",
    authorNationality: "Nacionalidade",
    authorBornDate: "Data de Nascimento",
    authorDiedDate: "Data de Falecimento",
    authorCreated: "Autor criado com sucesso!",
    authorUpdated: "Autor atualizado com sucesso!",
    authorDeleted: "Autor excluído com sucesso!",
    selectAuthors: "Selecionar autores",
    noAuthors: "Nenhum autor encontrado",
    preciseRating: "Nota Exata",
    loading: "Carregando",
  },
  en: {
    // Navigation
    ...
    personalReadingSpeed: "Personal Reading Speed",
    ...
    dashboardSubtitle: "Track your literary progress and discover new habits.",
    pagesRead: "Pages Read",
    totalRead: "Total pages",
    readInYear: "Read in {year}",
    ...
    wasRemovedFromCollection: "was removed from your collection.",
    deleteConfirm:
    ...
    personajesCount: "Characters",
    quotesCount: "Quotes",
    addedOn: "Added on",
    viewDetails: "View Details",
    addedToFavorites: "Added to Favorites",
    addedToFavoritesDesc: "was added to your favorites",
    ...
    manageCollectionsForBook: "Manage collections for this book",
    collectionsUpdated: "Collections updated!",
    collectionDeleted: "Collection deleted successfully!",
    booksInCollectionCount: "{count} books",
    ...
    authorBornDate: "Birth Date",
    authorDiedDate: "Death Date",
  ...
  es: {
    ...
    personalReadingSpeed: "Velocidad de Lectura Personal",
    wpm: "palabras por minuto",
    estimatedCompletion: "Previsión de Conclusión",
    ...
    dashboardSubtitle: "Sigue tu progreso literario y descubre nuevos hábitos.",
    pagesRead: "Páginas Leídas",
    totalRead: "Páginas totales",
    readInYear: "Leídos en {year}",
    ...
    selectedGenres: "Géneros Selecionados",
    ...
    wasRemovedFromCollection: "fue eliminado de tu colección",
    quickView: "Vista Rápida",
    hasReview: "Tiene reseña",
    personajesCount: "Personajes",
    quotesCount: "Citas",
    addedOn: "Añadido el",
    viewDetails: "Ver Detalles",
    addedToFavorites: "Añadido a Favoritos",
    addedToFavoritesDesc: "fue añadido a tus favoritos",
    ...
    manageCollectionsForBook: "Gestionar colecciones para este libro",
    collectionsUpdated: "¡Colecciones actualizadas!",
    collectionDeleted: "¡Colección eliminada con éxito!",
    booksInCollectionCount: "{count} libros",
    noBooksInCollection: "Ningún libro en esta colección",
    items: "ítems",
    viewCollection: "Ver Colección",
    // Autores
    authors: "Autores",
    addAuthor: "Añadir Autor",
    manageAuthors: "Gestionar Autores",
    authorName: "Nombre del Autor",
    authorBio: "Biografía del Autor",
    authorNationality: "Nacionalidad",
    authorBornDate: "Fecha de Nacimiento",
    authorDiedDate: "Fecha de Fallecimiento",
    authorCreated: "¡Autor creado con éxito!",
    authorUpdated: "¡Autor actualizado con éxito!",
    authorDeleted: "¡Autor eliminado con éxito!",
    selectAuthors: "Seleccionar autores",
    noAuthors: "No se encontraron autores",
    preciseRating: "Nota Exacta",
    loading: "Cargando",
  },
  fr: {
    // Navigation
    ...
    personalReadingSpeed: "Vitesse de Lecture Personnelle",
    wpm: "mots par minute",
    estimatedCompletion: "Prévision d'Achèvement",
    ...
    dashboardSubtitle: "Suivez votre progression littéraire et découvrez de nouvelles habitudes.",
    pagesRead: "Pages Lues",
    totalRead: "Pages totales",
    readInYear: "Lus en {year}",
    ...
    wasRemovedFromCollection: "a été supprimé de votre collection",
    quickView: "Aperçu Rapide",
    hasReview: "A un avis",
    personajesCount: "Personnages",
    quotesCount: "Citations",
    addedOn: "Ajouté le",
    viewDetails: "Voir les Détails",
    addedToFavorites: "Ajouté aux Favoris",
    addedToFavoritesDesc: "a été ajouté à vos favoris",
    ...
    manageCollectionsForBook: "Gérer les collections pour ce livre",
    collectionsUpdated: "Collections mises à jour !",
    collectionDeleted: "Collection supprimée avec succès!",
    booksInCollectionCount: "{count} livres",
    noBooksInCollection: "Aucun livre dans cette collection",
    items: "articles",
    viewCollection: "Voir la Collection",
    // Auteurs
    authors: "Auteurs",
    addAuthor: "Ajouter un Auteur",
    manageAuthors: "Gérer les Auteurs",
    authorName: "Nom de l'Auteur",
    authorBio: "Biographie de l'Auteur",
    authorNationality: "Nationalité",
    authorBornDate: "Date de Naissance",
    authorDiedDate: "Date de Décès",
    authorCreated: "Auteur créé avec succès !",
    authorUpdated: "Auteur mis à jour avec succès !",
    authorDeleted: "Auteur supprimé avec succès !",
    selectAuthors: "Sélectionner des auteurs",
